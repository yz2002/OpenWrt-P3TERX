...
# Modify SSID
sed -i 's/wireless.default_radio${devidx}.ssid=OpenWrt/wireless.default_radio${devidx}.ssid=Xiaomi-AX3600/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
# Modify hostname
sed -i 's/ImmortalWrt/Xiaomi_AX3600/g' package/base-files/files/bin/config_generate
...
# Modify banner
sed -i "s/OpenWrt/Xiaomi AX3600's Openwrt/g" files/etc/banner
