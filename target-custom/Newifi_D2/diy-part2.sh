...
# Modify SSID
sed -i 's/wireless.default_radio${devidx}.ssid=OpenWrt/wireless.default_radio${devidx}.ssid=NewifiD2/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
# Modify banner
sed -i "s/OpenWrt/Newifi D2's Openwrt/g" files/etc/banner