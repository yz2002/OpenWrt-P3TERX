...
# Modify SSID
sed -i 's/wireless.default_radio${devidx}.ssid=OpenWrt/wireless.default_radio${devidx}.ssid=MiAC2100/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
# Modify hostname
sed -i 's/OpenWrt/MiAC2100/g' package/base-files/files/bin/config_generate
...
# Modify banner
sed -i "s/OpenWrt/Mi AC2100's Openwrt/g" files/etc/banner